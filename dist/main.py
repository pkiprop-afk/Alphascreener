...
DATA_DIR = os.path.join(os.path.dirname(APP_PATH), "src", "data")
...
def initialize_session_state() -> None:
    ...
    defaults = {
        ...
        "risk_reward": DEFAULT_STRATEGY["risk_model"]["risk_reward"],
        "max_holding_bars": DEFAULT_STRATEGY["risk_model"]["max_holding_bars"],
        "universe_size": 50,
